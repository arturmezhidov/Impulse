define(['../module'], function (module) {
	...
	function materialsEditController($scope, $stateParams, dataContext, NgTableParams) {
		...
		function del(row) {
			dataContext.materials.remove(row.Id, function(response) {
	...
	//	module.directive("demoTrackedTable", demoTrackedTable);
	...
	//	module.directive("demoTrackedTableRow", demoTrackedTableRow);
	...
	//	module.directive("demoTrackedTableCell", demoTrackedTableCell);
